...
export function Login() {
  ...
  const features = [
    {
      ...
      orb: "from-cyan-500/20 to-transparent",
    },
    {
      icon: Lock,
      ...
      orb: "from-violet-500/20 to-transparent",
    },
    {
      icon: CheckCircle2,
      ...
      orb: "from-emerald-500/20 to-transparent",
    },
  ];
  ...
  const steps = [
    {
      step: "1",
      text: 'Click "Sign In to Continue" below',
...
// Keep ShieldCheck import satisfied
